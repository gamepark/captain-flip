...
use [our template on Github](https://github.com/gamepark/board-captain-flip)
...
- `captain-flip` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [GameTemplateRules.ts](/rules/src/CaptainFlipRules.ts)
